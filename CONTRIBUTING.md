# Contributing to Basket Configurator

Basket Configurator is an open source community project, and everyone is welcome to contribute. This short guide will assist you with the workflow required in successfully having your features and bug fixes merged into the project.
...
The best approach to contribute code to Basket Configurator is to fork the [main repository](https://github.com/salindersidhu/basket-configurator) on GitHub, then submit a pull request.
...
```bash
git clone https://github.com/salindersidhu/basket-configurator.git

# If you have an SSH key setup with GitHub
git clone git@github.com:USERNAME/basket-configurator.git

# Navigate to your cloned fork
cd basket-configurator
```
...
git remote add upstream https://github.com/salindersidhu/basket-configurator.git
```
...
If you find a bug in the code, please submit a ticket to the [Bug Tracker](https://github.com/salindersidhu/basket-configurator/issues).
...
- The version of the Basket Configurator app you are using.
